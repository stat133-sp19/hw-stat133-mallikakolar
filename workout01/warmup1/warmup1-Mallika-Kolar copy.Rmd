...
#__Star Wars__
I chose the character _Tamara Ryvora_
...
#__Recipe__
I chose the recipe for _Shakshuka_
...
In Cartesian Coordinates, if **p** = \((p_1, p_2,...,p_n)\) and **q** = $(q_1, q_2,...,q_n)$ are two points in Euclidian n-space, then the distance (d) from **p** to **q**, or from **q** to **p** is gien by the Pythagorean formula:\
\
